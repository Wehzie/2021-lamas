...
class Round {
    ...
    player_ask_agent(player){
        ...
        while(chosen_player_index != 1 || chosen_player_index != 1){
            if(first){
                chosen_player_index = prompt('Type the number of who you wish to ask\n1: AI1\n2:AI2')
                first = false
                

            } else {
                chosen_player_index = prompt('Invalid input, choose either the value 1 or 2\n1: AI1\n2:AI2')
            }  
        }
        ...
        while(true){
            if(first){
                chosen_card_value = prompt('Type the which value of cards you would like to ask the player\n 2-10 or A, J, Q, K\nNote: you must have that card value in your hand')
                first = false

            } else {
                chosen_card_value = prompt('Invalid input, choose an int between 2 and 10 or the uppercase letters: A, J, Q, K\nMake sure you have that card value in your hand')
            }  
            ...
            if(chosen_card_value > 0 || chosen_card_value < this.num_of_card_sets || chosen_card_value == 'A' || chosen_card_value == 'J' || chosen_card_value == 'Q' || chosen_card_value == 'K' ){
